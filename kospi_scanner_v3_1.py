...
if __name__ == "__main__":
    # ✅ 연결 확인용 메시지 (성공 시 즉시 전송됨)
    send_telegram("🚀 [인베스트웰스] 코스피 200 스캐너가 정상 가동되었습니다.")
    ...
    if results:
        ...
        send_telegram("📊 코스피 200 스나이퍼 리포트\n━━━━━━━━━━━━━━\n\n" + "\n\n".join(lines) + f"\n\n상세 분석: {BLOG_URL}")
    else:
        send_telegram("ℹ️ 현재 코스피 200 중 스나이퍼 조건(50점)을 충족하는 종목이 없습니다.")
